...
export default {
  ...
  methods: {
    initCharts() {
        ...
        series: [
          {
            ...
            symbolSize: 20,
            symbol:
              'image://https://pic.ulecdn.com/item/user_0102/desc20190115/1fb19e0cf39aafef_-1x-1.png',
            symbolRotate: 35,
            label: {
              normal: {
                formatter: '{b}',
      ...
      this.faultByHourTime = window.setInterval(function() {
        //使得tooltip每隔三秒自动显示
  ...
  beforeDestroy() {
    window.clearInterval(this.faultByHourTime)
  },
  watch: {},
  created() {}
}
